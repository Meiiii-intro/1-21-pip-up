...
![Berlin Noise Example](./images/Berlin_noise-1.png)
...
2. Morphological Sculpting - git.gl.nurbs
...
![How to open visual](./images/open_visual.png)
...
## Requirements
Software: Max 9 / Jitter
Knowledge Base: Cycling'74 Learning Documentation(Useful for understanding the patch logic)